...
export class TipoGastoController {
  ...
  @Post()
  registrarTipoGasto(@Body() createTipoGastoDto: CreateTipoGastoDto) {
    return this.tipoGastoService.registrarTipoGasto(createTipoGastoDto);
  }

  @Get()
  findAll() {
    return this.tipoGastoService.getAllTipoGastos();
  }
